...
describe("toScreamingSnakeCase", () => {
  ...
  describe("separator handling", () => {
    ...
    it("collapses consecutive separators", () => {
      expect(toScreamingSnakeCase("hello___world")).toBe("HELLO_WORLD");
    });

    it("handles leading and trailing separators", () => {
      expect(toScreamingSnakeCase("__hello_world__")).toBe("HELLO_WORLD");
    });

    it("handles mixed separators", () => {
      expect(toScreamingSnakeCase("hello-_./world")).toBe("HELLO_WORLD");
    });
  });
  ...
  describe("camelCase and PascalCase input", () => {
    ...
    it("splits multi-word camelCase", () => {
      expect(toScreamingSnakeCase("myVariableName")).toBe("MY_VARIABLE_NAME");
    });
    ...
    it("handles acronym at start", () => {
      expect(toScreamingSnakeCase("HTTPSRequest")).toBe("HTTPS_REQUEST");
    });

    it("handles acronym at end", () => {
      expect(toScreamingSnakeCase("requestHTTPS")).toBe("REQUEST_HTTPS");
    });
  ...
  describe("numeric tokens", () => {
    ...
    it("handles standalone number token", () => {
      expect(toScreamingSnakeCase("version 2 api")).toBe("VERSION_2_API");
    });
  ...
  describe("real-world inputs", () => {
    ...
    it("handles mixed case with separators", () => {
      expect(toScreamingSnakeCase("My-Var_name.here")).toBe("MY_VAR_NAME_HERE");
    });
